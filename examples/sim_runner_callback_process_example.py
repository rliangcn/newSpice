...
import sys
sys.path.insert(0, '..')    # This is to allow the import from the newSpice folder
from newSpice import SimRunner, SpiceEditor
from newSpice.sim.process_callback import ProcessCallback  # Importing the ProcessCallback class type
